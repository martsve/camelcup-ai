function CamelGame(div)
{
    ...
    self.Reset = function() 
    {
        ...
        for (key in players)
        {
            ...
            $div.find('.players').append('<li class="player" id="player'+id+'"><span class="name"></span> <span class="money"></span><div class="cards"></div><div class="winnerbets"></div><div class="loserbets"></div><div class="trap" id="trap'+id+'"><span class="value"></span><span class="owner">'+name+'</span></div></li>');
